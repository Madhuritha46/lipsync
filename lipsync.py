...
print("AV in sys.modules:", "av" in sys.modules)

try:
    import av
    print("AV IMPORT: SUCCESS")
    print("AV LOCATION:", av.__file__)
except Exception as e:
    print("AV IMPORT FAILED:", repr(e))
